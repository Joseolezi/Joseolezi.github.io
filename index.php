...
<body>
    ...
    <!-- style="border: 0px none; margin-left: 0.5rem; margin-right: 0.5rem; height: 45rem; margin-top: -230px; width: 100%;"-->
        <div class="form-title-container" id="form-title-container">
            ...
            <p>jose.fandos.pgs@gmail.com</p>
        </div>
    <div class="formContainer id=formContainer">
        <div class="email">
            <form id="formulario" action="send_email.php" method="post" onsubmit="sendEmail(); reset(); return false;">
                
                <input type="text" id="InputName" type="text" name="nombre" placeholder="Nombre y apellidos*" required></input>
                <input type="email" id="InputEmail" type="text" name="Email" placeholder="Email*" required></input>
                <input type="number" id="InputTel" type="text" name="Tel" placeholder="Teléfono"></input>
